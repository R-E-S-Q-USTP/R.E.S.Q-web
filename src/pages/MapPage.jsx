  ...
  return (
    <Layout>
      <div className="space-y-6">
        {/* Page Header */}
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Geographic Map</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 card">
            <div className="aspect-[16/10] bg-slate-100 rounded-lg flex items-center justify-center border-2 border-dashed border-slate-300">
            ...
            <div className="mt-4 flex flex-wrap gap-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-slate-600">Active Incident</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-slate-600">Sensor</span>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-2 max-h-64 overflow-y-auto">
                  {incidents.slice(0, 10).map((incident) => (
                    <button
                      ...
                      className="w-full text-left p-3 rounded-lg bg-red-50 border border-red-200 hover:bg-red-100 transition-colors"
                    >
              ...
              <div className="space-y-2 max-h-64 overflow-y-auto">
                {devices.map((device) => (
                  <button
                    ...
                    className="w-full text-left p-3 rounded-lg bg-slate-50 border border-slate-200 hover:bg-slate-100 transition-colors"
                  >
                    <div className="flex items-start space-x-2">
                      {device.type === "camera" ? (
                        <Camera className="w-4 h-4 text-blue-600 mt-0.5" />
                      ) : (
                        <Radio className="w-4 h-4 text-green-600 mt-0.5" />
                      )}
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-slate-900 truncate">
                          {device.name}
